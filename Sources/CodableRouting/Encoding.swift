...
public func encode<Route: Encodable>(_ value: Route) throws -> String {
...
struct RouteEncoder: Encoder {
    ...
    func container<Key>(keyedBy type: Key.Type) -> KeyedEncodingContainer<Key> where Key : CodingKey {
        KeyedEncodingContainer(RouteKeyedEncodingContainer(components: components))
    }
...
struct RouteKeyedEncodingContainer<Key: CodingKey>: KeyedEncodingContainerProtocol {
    ...
    mutating func encode(_ value: Int, forKey key: Key) throws {
        components.value.append(String(value))
    }
    ...
    mutating func nestedContainer<NestedKey>(keyedBy keyType: NestedKey.Type, forKey key: Key) -> KeyedEncodingContainer<NestedKey> where NestedKey : CodingKey {
        ...
        return KeyedEncodingContainer(RouteKeyedEncodingContainer<NestedKey>(components: components))
    }
